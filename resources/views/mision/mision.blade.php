                ...
                <div class="row">
                    <div class="col-md-4 col-12 justify-content-center mb-5">
                        <div class="card m-auto" style="width: 18rem;">
                            <img class="card-img-top" src="{{asset('images/MISION.jpg')}}" alt="Post MISION">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 col-12 justify-content-center mb-5">
                        <div class="card m-auto" style="width: 18rem;">
                            <img class="card-img-top" src="{{asset('images/VISION.jpg')}}" alt="Post VISION">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 col-12 justify-content-center mb-5">
                        <div class="card m-auto" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-card-text">
                                Confianza - Colaboración - Transparente - Valentía - Respeto al compañero - Actitud positiva - Tiempo – Comunicación.
                                <hr>
                                ...
                                <hr>
                                Ser responsables al momento de cumplir con lo que el cliente solicita el tiempo adecuado.
                                </div>
                            </div>
                        </div>
                    </div>
